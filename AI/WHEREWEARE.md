...
- v0.4.0: 4 passes (+`pack_file` whole-file encryption, `__forge_packed_v1` tag).
  Full chain on real 68KB file: node --check OK, runtime identical. `ai_confuse` removed (minimalism).
